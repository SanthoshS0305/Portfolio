...
const Content = () => {
  ...
  useEffect(() => {
    ...
    // Cleanup function
    return () => {
      if (document.head.contains(instagramScript)) {
        document.head.removeChild(instagramScript);
      }
      if (document.head.contains(tiktokScript)) {
      ...
      >
        <div className="content-item-header">
          ...
          <div className="content-meta">
            ...
            <span className="content-date">{new Date(item.dateAdded).toLocaleDateString()}</span>
          </div>
        </div>
  ...
  // Get unique platforms and categories for filter options
